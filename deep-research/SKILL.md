...
Sourced from [samber/cc-skills](https://github.com/samber/cc-skills) (MIT License, Copyright (c) 2026 Samuel Berthe). Authors: Maxme Courant, Samuel Berthe. Redistributed unmodified (except a one-word description tweak for skill-validator compatibility) as part of dante-skills.
